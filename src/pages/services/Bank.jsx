...
import Bankpngone from '../../../public/images/bankpng/bank (1).png'

export default function Bank() {
  return (


    <div className='bg-slate-200 opacity-80 h-fit w-80 flex justify-center items-center rounded-md  p-4'>
      <input type='checkbox' />
        <div className='flex justify-center items-center space-x-9'>
        <img src={Bankpngone} className='h-20 '/>
        <div className='flex items-center justify-center' >
            <div className='flex flex-col'>
        <span className='text-2xl font-bold  text-center'>Bank</span>
